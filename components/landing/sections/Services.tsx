      ...
      <div className="text-right mb-12 md:mb-16">
        <Reveal>
          <div className="inline-block mb-4">
            <span className="text-emerald-400 font-mono text-xs md:text-sm tracking-wider uppercase">/// ماذا_نبني</span>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400">برمجيات ذكية للمستقبل</h2>
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl ml-auto mr-0 font-normal leading-relaxed">
